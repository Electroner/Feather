...
void ImageWork::toolSelection(int _MouseImagePositionX, int _MouseImagePositionY) {
	...
	//Fix this
	//If the current point is less than the first point set the min to the current point
	...
	//If the current point is bigger than the first point set the max to the current point
	if (_MouseImagePositionX > this->firstPoint.first) {
